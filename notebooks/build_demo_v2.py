...
CELLS.append(code(
    ...
    "    #    FAILED on the comma in 'numpy>=1.26,<2.0' — bash split the version",
    "    #    spec, tried to run '2.0' as a command, error was swallowed.",
    "    # The fix: literal %pip install line below (IPython parses it natively,",
    "    # single-quoted version spec survives bash).",
    "",
