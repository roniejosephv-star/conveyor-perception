...
CELLS.append(md(
    "---",
    "",
    "## §3 COMPARISON — your stack vs EverestLabs' stack",
    "",
    "The same code, three different hardware classes. The numbers below come from this run (T4) plus previously published M4 MPS numbers and EverestLabs' spec.",
))

# Cell 13 (code): M4 vs T4 vs EverestLabs
CELLS.append(code(
    "# --- Cell 12: M4 vs T4 vs EverestLabs (the comparison) ---",
    "from colab_session import get_state",
    "",
    "state = get_state()",
    "",
    "# Published / measured numbers (from BENCHMARKS.md)",
    "EVEREST_PUBLISHED = {",
    ...
    "import pandas as pd",
    "df = pd.DataFrame([",
    "    {'Metric': 'GPU', 'EverestLabs': EVEREST_PUBLISHED['gpu'], 'M4 (this Mac)': M4_MEASURED['gpu'], 'T4 (this run)': T4_MEASURED['gpu']},",
    "    {'Metric': 'Classes', 'EverestLabs': EVEREST_PUBLISHED['classes'], 'M4 (this Mac)': M4_MEASURED['classes'], 'T4 (this run)': T4_MEASURED['classes']},",
    "    {'Metric': 'Inference (ms)', 'EverestLabs': EVEREST_PUBLISHED['classification_ms'], 'M4 (this Mac)': M4_MEASURED['inference_ms'], 'T4 (this run)': T4_MEASURED['inference_ms']},",
    "    {'Metric': 'FPS', 'EverestLabs': EVEREST_PUBLISHED['fps'], 'M4 (this Mac)': M4_MEASURED['fps'], 'T4 (this run)': T4_MEASURED['fps']},",
    "    {'Metric': 'mAP@50', 'EverestLabs': '95% accuracy', 'M4 (this Mac)': M4_MEASURED['mAP50'], 'T4 (this run)': T4_MEASURED['mAP50']},",
    "    {'Metric': 'Pick success', 'EverestLabs': f\"{EVEREST_PUBLISHED['pick_success_pct']}%\", 'M4 (this Mac)': 'n/a (no robot)', 'T4 (this run)': 'n/a (no robot)'},",
    "])",
    "",
    ...
    "print('  • T4 inference is ~3-4x faster than M4 MPS for this workload.')",
    ...
    "print('  • The mAP50 of 0.671 is for our 4-class recycling subset. Everest publishes 95% accuracy on 60 classes.')",
    "",
